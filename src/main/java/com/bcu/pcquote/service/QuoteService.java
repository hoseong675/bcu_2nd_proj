...
public class QuoteService {
    ...
    private String buildPrompt(SurveyRequestDto dto, List<CandidatePart> pool) {
        ...
        sb.append("\n## 지시\n"
                + "**각 부품은 반드시 위 '용도'와 '상세 요구사항'에 맞는 적정 사양으로 고르고, 용도에 불필요한 고사양 부품(특히 외장 그래픽카드)을 절대 넣지 마라.**\n"
                + "- 사무/문서/엑셀/웹서핑 등 가벼운 작업: 외장 그래픽카드가 전혀 필요 없다(gpu_part_id 생략, CPU 내장그래픽 사용). "
                + "CPU는 저~중급으로 충분하고 RAM·저장장치도 과하게 크게 잡지 마라.\n"
                + "- 게이밍/영상편집/3D/AI 등 무거운 작업: 외장 그래픽카드와 그에 맞는 고성능 부품이 적합하다.\n\n"
                + "예산 내에서 아래 4가지 견적을 구성하라. 단 '가성비/안정성/최고성능'은 **해당 용도에 적합한 사양 범위 안에서의** 상대적 등급이다"
                + "(용도가 가벼우면 최고성능이라도 과한 부품을 넣지 마라):\n"
                + "1) 가성비 — 용도를 만족하는 최소 비용 구성\n"
                + "2) 안정성 — 용도 만족 + 전원부·발열·내구성 여유\n"
                + "3) 최고성능 — 용도 내에서 쾌적함을 높인 구성\n"
