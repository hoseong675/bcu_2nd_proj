...
public class CompatibilityValidator {
    ...
    private static final String SQL = """
            ...
            JOIN gpu_specs gpu      ON gpu.part_id = :gpuId
    ...
    public List<String> findViolations(Long cpuId, Long gpuId, Long mbId, Long ramId,
        ...
        if (anyNull(cpuId, gpuId, mbId, ramId, psuId, coolerId, caseId)) {
            return List.of("호환성 검증 불가: 필수 부품(CPU/GPU/메인보드/RAM/파워/쿨러/케이스) 누락");
        }
